      ...
      <div class="pl-6 pr-4 py-4 bg-[#232529] flex items-center justify-between">
        <div class="flex items-center">
          ...
          >
            <img
              class="rounded-full"
              src="https://abrakadabra.fun/uploads/posts/2022-01/1642443343_1-abrakadabra-fun-p-anime-paren-zloi-1.jpg"
              alt=""
            />
          </div>
          <div class="flex flex-col pl-3">
            <div class="text-sm text-gray-50">Иван Иванов</div>
            <span class="text-xs text-[#acacb0] font-light tracking-tight">
              ivanivanov1999@gmail.com
            </span>
          </div>
        </div>
        <button
